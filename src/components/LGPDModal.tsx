...
export default function LGPDModal({ isOpen, onAccept, onDecline }: LGPDModalProps) {
  return (
        ...
        <DialogHeader>
          ...
          <DialogDescription className="text-left space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              Todos os dados são criptografados e você pode solicitar remoção a qualquer momento. 
