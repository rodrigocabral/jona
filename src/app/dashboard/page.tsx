...
import { Heart, Calendar, BookOpen, Users, Settings, MessageCircle, Sparkles, MapPin } from 'lucide-react'
                ...
                >
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1 mt-2">
                        {connection.commonInterests.slice(0, 2).map((interest) => (
                          <span
                            key={interest}
                            className="px-2 py-1 bg-jona-blue-100 text-jona-blue-700 text-xs rounded-full"
                          >
                            {interest}
                          </span>
                        ))}
                  ...
                  <div className="flex space-x-2">
                    <Button
                      ...
                      aria-label={`Conectar com ${connection.name}`}
                    >
